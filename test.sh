...
make clean
make -j -C $LUAJIT HOST_CC="gcc -m32 -arch i386" CC="gcc" CROSS="$MARMALADE_BIN" TARGET_FLAGS="$MARMALADE_SDKF" TARGET_LDFLAGS="$MARMALADE_LDFLAG" TARGET_SYS=Linux TARGET=arm AR_FLAGS="-no-reorder-marmalade" clean
make -j -C $LUAJIT HOST_CC="gcc -m32 -arch i386" CC="gcc" CROSS="$MARMALADE_BIN" TARGET_FLAGS="$MARMALADE_SDKF" TARGET_LDFLAGS="$MARMALADE_LDFLAG" TARGET_SYS=Linux TARGET=arm AR_FLAGS="-no-reorder-marmalade"
mv $LUAJIT/src/libluajit.a $BUILD_DIR/arm/libluajit_d.a

#-------------------
#arm release 

MARMALADE_SDKF="-fmessage-length=0 -pipe -Wno-trigraphs -O0 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.8.sdk -gdwarf-2 -I/Developer/Marmalade/6.2/s3e/h -I/Developer/Marmalade/6.2/s3e/h/ext -I/Developer/Marmalade/6.2/s3e/h/std -I/Developer/Marmalade/6.2/s3e/h/std/c++ -I/Developer/Marmalade/6.2/s3e/h/ext_legacy -I/Developer/Marmalade/6.2/s3e/h/legacy -DMAC_OS_X_VERSION_MIN_REQUIRED=1070 -fconstant-cfstrings -D__CONSTANT_CFSTRINGS__ -funsigned-char -fno-strict-aliasing -fno-stack-protector -fno-short-enums -fshort-wchar -Wall -fomit-frame-pointer -Wno-unused -Wno-parentheses -pipe -ffunction-sections -mword-relocations -Wno-switch -Wno-psabi -fvisibility=hidden -nostdinc -fomit-frame-pointer -O3 -DLUAJIT_NO_LOG2 -DLUAJIT_NO_EXP2"
